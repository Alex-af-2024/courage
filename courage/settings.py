...
SECRET_KEY = 'django-insecure-17&w869x1aaufr+%tx(yt#l^^i6o@plibb6*!fppz=z(f99*4!'
...
# Si render.com pasa DATABASE_URL, la usamos como variable de entorno   <-- added
...
STATIC_URL = '/static/'  # static debe estar dentro de / / 
STATIC_ROOT = BASE_DIR / 'staticfiles/'  # added

STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'  # <-- Agregado para servir archivos estáticos en producción
